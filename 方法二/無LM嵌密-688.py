        ...
        for row in range(image_embed.shape[0]):
            for col in range(image_embed.shape[1]):                
                if location_map[row][col]!= 1 :                                                                     #非白區可嵌密
                    if (pixel_num%9) < 1 and embed_count < 688:                                                     #pixel_num對9取餘數，每9嵌1，共688(確保擁有最小可嵌區域pixel為6800的影像仍能嵌滿688)
...
Embed_mod('D:\\108RE\\MUNIT\\10000','D:\\108RE\\MUNIT\\5100NLM688',3,5100)